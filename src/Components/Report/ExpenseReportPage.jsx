...
export default function ExpenseReportPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(
        `http://localhost:8081/api/expenses/report/category/${userId}/${startDate}/${endDate}`
      );
      ...
      const chartData = {
        ...
        datasets: [
          {
            data: amounts,
            backgroundColor: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0', '#FF5733', '#C70039'],
            hoverBackgroundColor: ['#FF7386', '#36A4EC', '#FFDD57', '#4BC1C1', '#FF6743', '#D80042'],
          },
        ],
      };
  ...
  onMouseOver={(e) => {
    e.target.style.backgroundColor = '#4D55CC'; // Darker green on hover
